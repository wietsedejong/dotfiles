...
echo -e "${NONE}"
if [ ! -d ~/wallpaper ]; then
    echo "Do you want to download the wallpapers from repository https://github.com/wietsedejong/wallpaper/ ?"
    ...
    if gum confirm "Do you want to download the repository?" ;then
        wget -P ~/Downloads/ https://github.com/wietsedejong/wallpaper/-/archive/main/wallpaper-main.zip
