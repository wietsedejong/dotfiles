...
if gum confirm "Do you want to start the update now?" ;then
    ...
    if [ "$version" == "main-release" ] ;then
        wget -P ~/Downloads/ https://github.com/wietsedejong/dotfiles/-/archive/main/dotfiles-main.zip
        v="main"
    elif [ "$version" == "rolling-release" ] ;then
        wget -P ~/Downloads/ https://github.com/wietsedejong/dotfiles/-/archive/dev/dotfiles-dev.zip
        v="dev"
    else
        exit 130
    fi
